...
struct	cdevsw	cdevsw[] =
{
	...
	nodev, nodev, nodev, nodev, nodev, nulldev, 0, /* serial = 4 */
	nodev, nodev, nodev, nodev, nodev, nulldev, 0, /* hd = 5 */
	nodev, nodev, nodev, nodev, nodev, nulldev, 0, /* fd = 6 */
	nodev, nodev, nodev, nodev, nodev, nulldev, 0, /* md = 7 */
	nodev, nodev, nodev, nodev, nodev, nulldev, 0, /* cd = 8 */
	0
};
